...
ChatBotFrame::ChatBotFrame(const wxString &title)
  ...
  Bind(wxEVT_TEXT_ENTER, &ChatBotFrame::OnEnter, this, idTextXtrl);
...
ChatBotFrameImagePanel::ChatBotFrameImagePanel(wxFrame *parent)
    : wxPanel(parent) {
  Bind(wxEVT_PAINT, &ChatBotFrameImagePanel::paintEvent, this);
}
...
ChatBotPanelDialog::ChatBotPanelDialog(wxWindow *parent, wxWindowID id)
  ...
  Bind(wxEVT_PAINT, &ChatBotPanelDialog::paintEvent, this);
...
ChatBotPanelDialog::~ChatBotPanelDialog() {
  //// STUDENT CODE
  ////
  //https://wiki.wxwidgets.org/WxSizer
...
ChatBotPanelDialogItem::ChatBotPanelDialogItem(wxPanel *parent, wxString text,
  ...
  wxBitmap *bitmap = (isFromUser == true) 
      ? NULL
